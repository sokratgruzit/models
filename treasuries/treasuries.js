  ...
  try {
    ...
    if (!existingTreasuries) {
      const initialTreasuries = new Treasuries({
        incoming: { ATR: 0, BTC: 0, BNB: 0, ETH: 0, TETHER: 0, GOLD: 0, PLATINUM: 0 },
        pendingWithdrawals: { ATR: 0, BTC: 0, BNB: 0, ETH: 0, TETHER: 0, GOLD: 0, PLATINUM: 0 },
        withdrawals: { ATR: 0, BTC: 0, BNB: 0, ETH: 0, TETHER: 0, GOLD: 0, PLATINUM: 0 },
      });
